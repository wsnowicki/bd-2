...
with open(f"image1", "wb") as file:
    bity=file.read()
zap = "INSERT INTO books (isbn, title, author_id, year_published,is_available,cover_image) VALUES ('322421','o trzech takich co wynaleźli UML-a','1',"2020","1",'"+str(bity)+"'"    
cursor.execute(zap)
zap= "INSERT INTO books (isbn, title, author_id, year_published,is_available,cover_image) VALUES ('322420','Czy Studia się opłacają?','2',"2024","1",'"+str(bity)+"'"
cursor.execute(zap)
zap= "INSERT INTO books (isbn, title, author_id, year_published,is_available,cover_image) VALUES ('322429','Spóźnialska Asia','3',"2023","1",'"+str(bity)+"'"
cursor.execute(zap)
zap= "INSERT INTO books (isbn, title, author_id, year_published,is_available,cover_image) VALUES ('322428','Half-life 3 na tropie legnedy','1',"1999","1",'"+str(bity)+"'"
cursor.execute(zap)
